...
class Effect{
     ...
     * @Fx 2016-12-15
     */
    public static macIconShake(obj: string, initY: number, loop: boolean = false, optionArr: any[] = [], waitTime: number = 0): string {
        //抖动频率[时间，移动距离]，可修改
        var arr: Array<any> = [
            [20, 300],
            [15, 300],
    ...
    /**
      *  动画函数 fadeIn fx
      */
    public static fadeIn(el: any, dt: number, waitTime: number = 0, cb?: Function): void {
     ...
     *  动画函数 fadeOut fx
     */
    public static fadeOut(el: any, dt: number, waitTime: number = 0, cb?: Function): void {
    ...
    public static zoomInBig(el: any, dt: number, cb?: Function): void {
    ...
    public static blinkEffect(obj, alpha: number = 0, time: number = 500, delay: number = 100): void {
