...
(function (PanelEffect) {
    ...
    */
    function addPopUp(panel, dark, popUpWidth, popUpHeight, effectType, isAlert) {
        ...
        //以下是弹窗动画
        var leftX = Store.stageWidth / 2 - popUpWidth / 2;
        var upY = Store.stageHeight / 2 - popUpHeight / 2;
        switch (effectType) {
            case 0:
                break;
            case 1:
    ...
    */
    ...
    PanelEffect.removePopUp = removePopUp;
})(PanelEffect || (PanelEffect = {}));
//# sourceMappingURL=PanelEffect.js.map